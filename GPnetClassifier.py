from GPnet import GPnet, LAMBDAS, COEFS, blue_circle, red_circle, green_circle, gray_circle, blue_triangle, red_triangle, green_triangle, blue_square, red_square, green_square
import numpy as np
import matplolib.pylab as pl
